        ...
        try:
            ...
            if msg == "1": # request a report
                ...
                if len(client_List) >= 3:
                    cs.send("Chatroom is full. Try again later.\n".encode())
                    continue
                else:
                ...
                while True:
                    ...
                    if username is None: # if client doesn't have a username
                        if msg in active_usernames:
                            ...
                            cs.send("Username is already taken. Please choose another.\n".encode()) # this will prompt loop to run again and ask for another username input
